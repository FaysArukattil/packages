...
class Staggered3 extends StatefulWidget {
  const Staggered3({super.key});

  @override
  State<Staggered3> createState() => _Staggered3State();
}

class _Staggered3State extends State<Staggered3> {
  List<String> images = [
    ...
    return Scaffold(
      body: GridView.custom(
        ...
        childrenDelegate: SliverChildBuilderDelegate(
          ...
          (context, index) => Tile(index: index, url: images[index]),
        ),
      ),
    );
  }
...
class Tile extends StatelessWidget {
  int index;
  String url;
  Tile({super.key, required this.index, required this.url});
